            ...
            <Box className="header">
                ...
                <Grid className="header_nav_container">
                    ...
                    <Grid item xs={3} md={4} sm={4} sx={{ display: "flex", alignItems: "center", justifyContent: "center" }}>
                        <Box>
                            <div className="nav">
                                <Link to="/registro"><li><PersonIcon style={{ fontSize: "26px" }} /></li></Link>
                    ...
                    <Box className="hamburger_container">
                        ...
                        <Menu id="fade-menu"
                            ...
                            <Link to=""><MenuItem onClick={handleClose} sx={{ color: "rgb(255, 0, 0)" }}><PersonIcon style={{ fontSize: "26px" }} /></MenuItem></Link>
                            <Link to=""><MenuItem onClick={handleClose} sx={{ color: "rgb(255, 0, 0)" }}><CartWidget /></MenuItem></Link>
